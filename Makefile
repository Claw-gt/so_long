...
#    Updated: 2024/09/10 13:21:00 by clagarci         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MY_SOURCES = src/tutorial.c src/parse_map.c src/check_path.c src/display.c src/controls.c src/errors.c # src/so_long.c 
